// inspired by kimi m-base

var injectRem, dp2rem, rem2dp, noop = function() {}, injected = false;
...
if (typeof window === "undefined") {
  ...
  injectRem = function() {
    ...
    function setUnitA() {
      var docWidth = docEl.clientWidth, extraStyle = "}";
      ...
      fontEl.innerHTML =
        "html{font-size:" + rem + "px!important;}body{" + extraStyle;
